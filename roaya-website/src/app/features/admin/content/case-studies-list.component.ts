    ...
    <div class="content-page p-6">
      ...
      @if (loading()) {
        <div class="flex flex-col items-center justify-center py-16">
          ...
          <p class="mt-4 text-sm text-content-muted">Loading case studies...</p>
        </div>
      } @else {
        <!-- Content Table -->
        <div class="bg-surface-elevated rounded-xl border border-edge-subtle overflow-x-auto">
          <!-- Table Header -->
          <div class="hidden lg:grid grid-cols-[minmax(200px,1fr)_100px_100px_60px_100px] gap-4 px-6 py-3 bg-surface-secondary border-b border-edge-subtle min-w-[600px]">
            <span class="text-xs font-semibold uppercase tracking-wide text-content-muted">Title</span>
            <span class="text-xs font-semibold uppercase tracking-wide text-content-muted">Industry</span>
          ...
          @if (contents().length > 0) {
            @for (item of contents(); track item.id) {
              <div class="grid grid-cols-1 lg:grid-cols-[minmax(200px,1fr)_100px_100px_60px_100px] gap-4 px-6 py-4 items-center border-b border-edge-subtle last:border-b-0 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors min-w-[600px]">
                <!-- Title & Image -->
